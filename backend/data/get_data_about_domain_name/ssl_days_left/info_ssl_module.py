...
class SSLChecker:
        ...
        for host in hosts:
            ...
            try:
                ...
                if not user_args.json_true:
                    print('\t{}[-]{} {:<20s} Failed: Misconfigured ssl_days_left/TLS\n'.format(Clr.RED, Clr.RST, host))
                    self.total_failed += 1
    ...
    def get_args(self, json_args={}):
        parser = ArgumentParser(prog='checkerSSLModule.py', add_help=False,
                                description="""Collects useful information about given host's ssl_days_left certificates.""")
        ...
        parser.add_argument('-a', '--analyze', dest='analyze',
                            ...
                            help='Enable ssl_days_left security analysis on the host')
